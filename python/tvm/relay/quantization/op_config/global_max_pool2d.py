...
class GlobalMaxPool2D:
    ...
    def __init__(self, node, vertex_config, config):
        ...
        LOGGER.debug("[anaylze] global_max_pool2d finish")
    ...
    def quantize_params(self, node, vertex_config):
        """quantize_params"""
        LOGGER.info("[calibrate] global_max_pool2d start")
        arg = node.args[0]
    ...
    def realize(self, old_node, new_node, vertex_config, n2o):
        ...
        new_node = relay.nn.global_max_pool2d(new_arg, **dict(new_node.attrs))
        return new_node
