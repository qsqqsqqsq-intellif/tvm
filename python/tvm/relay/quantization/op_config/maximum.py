...
from ..method_dtype import _get_dtype_info
...
class Maximum:
    ...
    def quantize_params(self, node, vertex_config):
        ...
        scale = vertex_config[node.args[0]].output_config["scale"]
        zero_point = vertex_config[node.args[0]].output_config["zero_point"]
    ...
    def realize(self, old_node, new_node, vertex_config, n2o):
        ...
        new_node = relay.maximum(new_arg, **dict(new_node.attrs))
        return new_node
