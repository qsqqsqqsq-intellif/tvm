...
class Conv2D:
    ...
    def __init__(self, node, vertex_config, config):
        ...
        LOGGER.debug("[analyze] conv2d start")
        self.quantized = True
        ...
        LOGGER.debug("[analyze] conv2d finish")
    ...
    def realize(self, old_node, new_node, vertex_config, n2o):
        """realize"""
        LOGGER.debug("[realize]conv2d nobias start...")
        ...
        if self.quantized:
            new_node = relay.nn.conv2d(realized_args[0], realized_args[1], **attrs)
        ...
        new_node = relay.nn.conv2d(realized_args_n[0], realized_args_n[1], **attrs)
        return new_node
