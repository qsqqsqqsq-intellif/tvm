...
performance = {"float": 92.4, "int8": 91.6}
...
if os.path.exists(path):
    ...
    mod, params = get_relay_module(model_name, "pytorch", "/data/share/demodels-lfs")
    # mod, params = get_relay_module(model_name, "pytorch", "/home/yhh/Desktop/detvm/deepeye/demodels-lfs")
