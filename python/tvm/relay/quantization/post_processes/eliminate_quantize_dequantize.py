...
class EliminateQuantizeDequantize(ExprMutator):
    """eliminate quantize dequantize"""
    ...
    def visit_call(self, call):
        ...
        if self.dequantize.match(new_call):
...
def eliminate_quantize_dequantize(mod):
    mod = EliminateQuantizeDequantize(mod).new_mod
    return mod
