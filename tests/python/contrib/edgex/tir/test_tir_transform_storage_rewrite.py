...
def vu_example(a: T.handle, b: T.handle, c: T.handle) -> None:
    ...
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_dm, 0, 128, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A.data, 0, 128, 1, dtype="handle"),
        dtype="handle"))
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), B_dm, 0, 128, 2, dtype="handle"),
    ...
    for i in T.serial(2, 1):
        T.evaluate(T.nnp_vidma_load(T.type_annotation(dtype="int32"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_vm, 0, 64, 2, dtype="handle"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_dm, i * 64, 64, 1, dtype="handle"),
            dtype="handle"))
        T.evaluate(T.nnp_vidma_load(T.type_annotation(dtype="int32"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), B_vm, 0, 64, 2, dtype="handle"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), B_dm, i * 64, 64, 1, dtype="handle"),
            dtype="handle"))
        for j in T.serial(64, 1):
            C_vm[j] = T.load("int32", A_vm, j) + T.load("int32", B_vm, j)
        T.evaluate(T.nnp_vodma_store(T.type_annotation(dtype="int32"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), C_dm, i * 64, 64, 2, dtype="handle"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), C_vm, 0, 64, 1, dtype="handle"),
            dtype="handle"))
    T.evaluate(T.nnp_eodma_store(T.type_annotation(dtype="int32"),
        ...
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), C_dm, 0, 128, 1, dtype="handle"),
        dtype="handle"))
...
def vu_with_static_dma_offset(a: T.handle, b: T.handle, c: T.handle) -> None:
    ...
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_dm, 128, 128, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), B.data, 0, 128, 1, dtype="handle"),
    ...
    for i in T.serial(2, 1):
        ...
        T.evaluate(T.nnp_vidma_load(T.type_annotation(dtype="int32"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_vm, 64, 64, 2, dtype="handle"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_dm, (128 + (i*64)), 64, 1, dtype="handle"),
            "cb_buf_start_addr_vm_vidma=0x100", "cb_buf_end_addr_vm_vidma=0x1ff", dtype="handle"))
        for j in T.serial(64, 1):
            A_vm[(128 + j)] = (T.load("int32", A_vm, j) + T.load("int32", A_vm, (64 + j)))
        T.evaluate(T.nnp_vodma_store(T.type_annotation(dtype="int32"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_dm, (256 + (i*64)), 64, 2, dtype="handle"),
            T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_vm, 128, 64, 1, dtype="handle"),
            "cb_buf_start_addr_vm_vodma=0x200", "cb_buf_end_addr_vm_vodma=0x2ff", dtype="handle"))
    T.evaluate(T.nnp_eodma_store(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), C.data, 0, 128, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A_dm, 256, 128, 1, dtype="handle"),
...
def multiple_dm_buffer_with_alignment(a: T.handle) -> None:
    ...
    T.attr(DM1, "storage_alignment", 16)
    DM2 = T.allocate([256], "int32", "dm")
    T.attr(DM2, "storage_alignment", 80)
    DM3 = T.allocate([256], "int32", "dm")
    T.attr(DM3, "storage_alignment", 2048)
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), DM1, 0, 256, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A.data, 0, 256, 1, dtype="handle"),
        dtype="handle"))
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), DM2, 0, 256, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A.data, 0, 256, 1, dtype="handle"),
        dtype="handle"))
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), DM3, 0, 256, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A.data, 0, 256, 1, dtype="handle"),
        dtype="handle"))
    # simulate use buffer
    DM3[0] = T.load("int32", DM1, 0) + T.load("int32", DM2, 0)
...
def multiple_dm_buffer_with_alignment_expect(a: T.handle) -> None:
    ...
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), DM1, 260, 256, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A.data, 0, 256, 1, dtype="handle"),
        "ei_start_addr1=0x410", "ei_end_addr1=0x80f", "ei_start_addr2=0x410", "ei_end_addr2=0x80f", dtype="handle"))
    T.evaluate(T.nnp_eidma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), DM1, 1024, 256, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), A.data, 0, 256, 1, dtype="handle"),
        "ei_start_addr1=0x1000", "ei_end_addr1=0x13ff", "ei_start_addr2=0x1000", "ei_end_addr2=0x13ff", dtype="handle"))
    # simulate use buffer
    DM1[1024] = T.load("int32", DM1, 0) + T.load("int32", DM1, 260)    
...
def simple_cube_dma() -> None:
    ...
    T.evaluate(T.nnp_idma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_buf, 0, 16*224*224, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_dm, 0, 16*224*224, 1, dtype="handle"), dtype=""))
    T.evaluate(T.nnp_wdma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), weight_buf, 0, 16*64*7*7, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), weight_dm, 0, 16*64*7*7, 1, dtype="handle"), dtype=""))
    T.evaluate(T.nnp_bdma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), bias_buf, 0, 64, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), bias_dm, 0, 64, 1, dtype="handle"), dtype=""))
    T.evaluate(T.nnp_cube(dtype=""))
    T.evaluate(T.nnp_odma_store(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), out_dm, 0, 64*112*112, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), out_buf, 0, 64*112*112, 1, dtype="handle"), dtype=""))
...
def simple_cube_dma_expect() -> None:
    ...
    T.evaluate(T.nnp_idma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_buf, 0, 16*224*224, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_dm, 0, 16*224*224, 1, dtype="handle"),
        "feat_st_addr1_idma=0x0", "feat_end_addr1_idma=0x30ffff",
        "feat_st_addr2_idma=0x0", "feat_end_addr2_idma=0x30ffff", dtype=""))
    T.evaluate(T.nnp_wdma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), weight_buf, 0, 16*64*7*7, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_dm, 200704, 16*64*7*7, 1, dtype="handle"),
        "wt_st_addr1_wdma=0xc4000", "wt_end_addr1_wdma=0xf4fff",
        "wt_st_addr2_wdma=0xc4000", "wt_end_addr2_wdma=0xf4fff", dtype=""))
    T.evaluate(T.nnp_bdma_load(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), bias_buf, 0, 64, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_dm, 213248, 64, 1, dtype="handle"),
        "st_addr1_bdma=0xd0400", "end_addr1_bdma=0xd04ff",
        "st_addr2_bdma=0xd0400", "end_addr2_bdma=0xd04ff", dtype=""))
    T.evaluate(T.nnp_cube(dtype=""))
    T.evaluate(T.nnp_odma_store(T.type_annotation(dtype="int32"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), in_dm, 213312, 64*112*112, 2, dtype="handle"),
        T.tvm_access_ptr(T.type_annotation(dtype="int32"), out_buf, 0, 64*112*112, 1, dtype="handle"),
...
def mixed_datatype() -> None:
    ...
    T.evaluate(T.load("int8", vm0, 0))
    T.evaluate(T.load("int32", vm1, 0))
    T.evaluate(T.load("int16", vm2, 0))
    T.evaluate(T.load("float32", vm3, 0))
    T.evaluate(T.load("int8", vm0, 0))
    T.evaluate(T.load("int32", vm1, 0))
    T.evaluate(T.load("int16", vm2, 0))
    T.evaluate(T.load("float32", vm3, 0))
...
def mixed_datatype_expect() -> None:
    ...
    T.evaluate(T.load("int8", vm0, 0))
    T.evaluate(T.load("int32", vm0, 256))
    T.evaluate(T.load("int16", vm0, 1024))
    T.evaluate(T.load("float32", vm0, 768))
    T.evaluate(T.load("int8", vm0, 0))
    T.evaluate(T.load("int32", vm0, 256))
    T.evaluate(T.load("int16", vm0, 1024))
    T.evaluate(T.load("float32", vm0, 768))
