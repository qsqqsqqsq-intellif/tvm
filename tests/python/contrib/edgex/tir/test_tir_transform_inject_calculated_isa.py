...
def inject_isa_transformed(a: T.handle, c: T.handle) -> None:
    ...
    T.evaluate(
        T.nnp_idma_load(
            ...
            "zeta_idma=16",
            "dense_idma=1",
            "epsilon_times_idma=1",
            "delta_times_idma=1",
            "zeta_times_idma=17",
            "dense_times_idma=1",
            "last_epsilon_idma=49",
            "last_delta_idma=1",
            "last_zeta_idma=6",
            "last_dense_idma=1",
            "last_zeta_width_idma=16",
            "eps_ci_times_idma=1",
            "last_eps_ci_times_idma=1",
            "ub_ci_num_idma=16",
            "wo_ci_num_idma=49",
            "wo_d_num_idma=1",
            "wo_h_num_idma=16",
    ...
    T.evaluate(
        T.nnp_wdma_load(
            ...
            "zeta_wdma=16",
            "dense_wdma=1",
            "epsilon_times_wdma=1",
            "delta_times_wdma=1",
            "zeta_times_wdma=17",
            "dense_times_wdma=1",
            "last_epsilon_wdma=49",
            "last_delta_wdma=1",
            "last_zeta_wdma=6",
            "last_dense_wdma=1",
            "epsilon_times_rewrite_dm_wdma=0",
            "delta_inc_addr_wdma=0",
            "ksize_inc_addr_wdma=24832",
            "epstimes_inc_addr_wdma=12544",
            "delta_times_inc_addr_wdma=0",
            "mat_row_offset_wdma=0",
            dtype="",
        )
    )
    ...
    T.evaluate(
        T.nnp_cube_compute(
            ...
            "zeta_cube=16",
            "dense_cube=1",
            "epsilon_times_cube=1",
            "delta_times_cube=1",
            "zeta_times_cube=17",
            "dense_times_cube=1",
            "last_epsilon_cube=49",
            "last_delta_cube=1",
            "last_zeta_cube=6",
            "last_dense_cube=1",
            "last_beta_remind_cube=3",
            "burst_size_pipe_num_cube=12838",
            dtype="",
        )
    )
    ...
    T.evaluate(
        T.nnp_odma_store(
            ...
            "last_zeta_odma=6",
            "last_dense_odma=1",
            "last_zeta_width_odma=16",
            "last_delta_co_odma=16",
            "zeta_offset_odma=192",
            "wino_zeta_add_en_odma=0",
            "init_xbar_wr_byte_odma=127",
            "last_xbar_co_times_odma=0",
            "last_xbar_pixel_times_odma=7",
            "last_xbar_wr_byte_odma=127",
            "last_xbar_cube_times_odma=0",
            "delta_times_transfer_co_odma=16",
            "delta_ch_offset_odma=802816",
            dtype="",
        )
    )
